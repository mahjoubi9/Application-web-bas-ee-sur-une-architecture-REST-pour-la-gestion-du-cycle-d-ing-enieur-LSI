...
<div class="register">
 <div class="leftpar">
<label>pays_nais</label>
<input class="form-control" type="text" v-model="pays_nais" :placeholder="pays_nais">
<label>adresse</label>
