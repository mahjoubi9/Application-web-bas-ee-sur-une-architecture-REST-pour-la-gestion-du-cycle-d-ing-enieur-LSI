...
<div class="register">
 <div class="leftparr">
<label>ajouté étudaint Succès (le nom est  {{nom}} )</label>
 <div class="content3">
 <ul>
 ...
 <div class="styled-input fields-grid register-form">
<router-link :to="{name:'etuList' , params:{id: this.id,nom: this.nom,prenom: this.prenom,sexe: this.sexe,civilite: this.civilite,situation_familiale: this.situation_familiale,date_naissance: this.date_naissance,ville_nais: this.ville_nais,nationalite: this.nationalite,cin: this.cin ,cne:this.cne,email:this.email,password:this.password,id_admin:this.id_admin,id_pfe:this.id_pfe,id_emp:this.id_emp,}}" @click="addetu()" class="botu" >ajouté</router-link>
</div>
 </ul>
 </div>
 </div>
