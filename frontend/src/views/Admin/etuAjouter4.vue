...
<input class="form-control" type="text" v-model="password" :placeholder="password">
 ...
 <div class="styled-input fields-grid register-form">
<router-link :to="{name:'etuAjouter5' , params:{id: this.id,nom: this.nom,prenom: this.prenom,sexe: this.sexe,civilite: this.civilite,situation_familiale: this.situation_familiale,date_naissance: this.date_naissance,ville_nais: this.ville_nais,nationalite: this.nationalite,cin: this.cin ,cne:this.cne,email:this.email,password:this.password,}}"  class="botu" >Suivant</router-link>
</div>
 </ul>
 </div>
 </div>
