...
<div class="register">
 <div class="leftpar">
<label>pays</label>
<input class="form-control" type="text" v-model="pays" :placeholder="pays">
<label>ville</label>
<input class="form-control" type="text" v-model="ville" :placeholder="ville">
<label>nationalite</label>
<input class="form-control" type="text" v-model="nationalite" :placeholder="nationalite">
<label>code_postal</label>
<input class="form-control" type="text" v-model="code_postal" :placeholder="code_postal">
 <div class="content3">
 <!--
            'id',
        'nom',
