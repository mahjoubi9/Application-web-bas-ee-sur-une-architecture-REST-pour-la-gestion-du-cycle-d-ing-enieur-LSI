...
<div class="register">
 <div class="leftparr">
<label>id_emp_temps</label>
<input class="form-control" type="text" v-model="id_emp_temps" :placeholder="id_emp_temps">
 <div class="content3">
 <ul>
