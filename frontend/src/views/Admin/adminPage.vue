<template>
<div class="register-fulll">
        <div class="register-righttt">
        <div class="register-in">
            <h2><span class="fa fa-pencil"></span> Option possible</h2>
                <div class="register-form">
                <form >
                    <div class="fields-grid">
                          <div class="styled-input">
                             <router-link to="/utilisateurGes" class="botu">Gestion des utilisateur</router-link>
                            </div>
                            <div class="styled-input">
                             <router-link :to="{name:'gestionDesnote'}" class="botu">Gestion des notes</router-link>
                            </div>
                            <div class="styled-input">
                             <router-link to="/" class="botu">Gestion des PFE</router-link>
                            </div>
                            </div>
                            </form>
                            </div>
